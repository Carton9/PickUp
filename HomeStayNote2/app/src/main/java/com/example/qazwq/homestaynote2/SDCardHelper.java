...
public class SDCardHelper {
    ...
    // 往SD卡的自定义目录下保存文件
    public static <T extends Object> boolean saveFileToSDCardCustomDir(T data, String dir,
                                                    String fileName) {
        ...
        if (isSDCardMounted()) {
            ...
            try {
                bos = new ObjectOutputStream(new FileOutputStream(new File(
                        file, fileName)));
    ...
    // 从SD卡获取文件
    public static <T extends Object>  T loadFileFromSDCard(String fileDir) {
